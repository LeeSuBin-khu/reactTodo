...
**할 일**
- [v] 할 일 입력 폼에는 제목, 상세설명, 태그, 마감 목표일을 입력할 수 있습니다.
...
- [v] 완료한 할 일 목록을 필터하여 볼 수 있습니다.
- [v] 완료한 할 일들은 일괄 삭제가 가능합니다.

**태그**
- [v] 할 일 입력 폼에서 태그를 여러개 입력할 수 있습니다.
- [v] 같은 이름의 태그는 중복입력이 안됩니다.
- [v] 할 일 목록에서 태그는 색상으로 구분되어야 합니다.
- [v] 목록에서 서로 다른 할 일에 같은 태그가 있다면, 같은 색으로 표시됩니다.

### c. 요구사항(선택)

선택 요구 사항은 가산점 항목입니다.

- [v] 입력할 때 validation 처리.
- [ ] 입력 중 뒤로가기 또는 브라우저를 닫으려고 할 때 입력된 내용 삭제 알림창.
- [ ] 마감일이 3일 이내인 할 일은 긴급함 표시가 보입니다.
- [v] 태그의 색상을 커스텀하게 바꿀 수 있습니다.
- [v] 할 일 삭제시 진짜로 삭제할 것인지 한번 더 물어보고 삭제됩니다.
- [ ] 할 일은 태그별, 완료여부별, 마감 기간, 생성일 기준으로 필터를 할 수 있습니다.
- [v] 브라우저창을 닫았다가 다시 열어도 데이터가 남아있습니다.
